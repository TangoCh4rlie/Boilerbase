  ...
  <div class="mb-5">
    ...
    <div class="mt-2 mb-1">
      <input
        ...
        name="features"
        id="features"
        class="pl-3 block w-full rounded-md border-0 py-1.5 dark:bg-gray-800 dark:border-gray-500 text-gray-900 dark:text-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
